...
# lowers slider
slider_lowers = Scale(topFrame, from_=1, to=10, orient=HORIZONTAL, variable=var_lowers, showvalue=0)
...
# uppers slider
slider_uppers = Scale(topFrame, from_=1, to=10, orient=HORIZONTAL, variable=var_uppers, showvalue=0)
...
# numbers slider
slider_numbers = Scale(topFrame, from_=1, to=10, orient=HORIZONTAL, variable=var_numbers, showvalue=0)
...
# punc slider
slider_punc = Scale(topFrame, from_=1, to=10, orient=HORIZONTAL, variable=var_punc, showvalue=0)
...
pwreg = root.register(nospaces)
entry_password.config(validate='key',validatecommand=(pwreg,'%P'))
